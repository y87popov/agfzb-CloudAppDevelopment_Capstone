...
def get_dealer_by_id_from_cf(url, id):
    ...
    if json_result:
        ...
        dealer_obj = CarDealer(address=dealer_doc["address"], city=dealer_doc["city"],
                                ...
                                st=dealer_doc["st"], zip=dealer_doc["zip"],  _id=dealer_doc["_id"],  _rev=dealer_doc["_rev"],  state=dealer_doc["state"], short_name=dealer_doc["short_name"] )
    return dealer_obj
...
def analyze_review_sentiments(text):
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/521d2861-1f73-4099-be44-34c188c24728"
    api_key = "vZM04h-l3TxMzZgixfuiaZlszHWyri1PoNlWGL3wMNrn"
